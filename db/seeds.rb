...
com= Comment.create([{user_id: 1, activity_id: 1, title: "Geoff Me", comment: 'Great food, Great burgers', rating: 5}])
comm= Comment.create([{user_id: 2, activity_id: 2, title: "Dried Up", comment: 'Fountain is not running', rating: 1}])
comment= Comment.create([{user_id: 2, activity_id: 1, title: "I'd go again", comment: 'Try the pizza and sit outside', rating: 3}])
